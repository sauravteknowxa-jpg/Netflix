...
function Netflix() {
  ...
  return (
    <>
        ...
        <div className="w-full bg-black flex flex-col items-start justify-start gap-6 text-center px-4 sm:px-8 md:px-8 lg:px-48  lg:py-12">
        ...
        <div className="w-full bg-black flex flex-col items-start justify-start gap-6 text-center px-4 sm:px-8 lg:px-48   lg:py-12">
        ...
        <div className="bg-black flex flex-col items-center justify-center gap-6 text-center px-4 sm:px-8 md:px-48 lg:px-96  lg:py-12">
        ...
        <div className="w-full bg-black flex flex-col items-center justify-center text-center  px-4 sm:px-8 md:px-16 ">
